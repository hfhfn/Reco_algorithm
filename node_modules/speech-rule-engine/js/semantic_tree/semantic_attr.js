...
import { SemanticFont, SemanticSecondary } from './semantic_meaning.js';
import * as Alphabet from '../speech_rules/alphabet.js';
export var NamedSymbol;
    ...
    for (const [name, font] of Object.entries(SemanticFont)) {
        ...
        const semfont = emb
            ...
            : font === SemanticFont.FULLWIDTH
                ? SemanticFont.NORMAL
                : font;
        singleAlphabet(Alphabet.Base.LATINCAP, "identifier", "latinletter", font, semfont, [SemanticSecondary.ALLLETTERS]);
        singleAlphabet(Alphabet.Base.LATINSMALL, "identifier", "latinletter", font, semfont, [SemanticSecondary.ALLLETTERS], {}, { 3: SemanticSecondary.D });
        singleAlphabet(Alphabet.Base.GREEKCAP, "identifier", "greekletter", font, semfont, [SemanticSecondary.ALLLETTERS]);
        singleAlphabet(Alphabet.Base.GREEKSMALL, "identifier", "greekletter", font, semfont, [SemanticSecondary.ALLLETTERS], {
            0: {
                type: "operator",
                role: "prefix operator",
                font: semfont
