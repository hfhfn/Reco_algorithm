...
const SemanticHeuristics = require("../semantic_tree/semantic_heuristic_factory.js");
...
function enrich(mml, semantic) {
    ...
    if (engine_js_1.default.getInstance().structure) {
...
function walkTree(semantic) {
    ...
    const childrenList = semantic_skeleton_js_1.SemanticSkeleton.combineContentChildren(semantic, newContent, newChildren);
