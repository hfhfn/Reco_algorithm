...
engine_js_1.default.getInstance().comparators['clearspeak'] =
    ClearspeakPreferences.comparator;
engine_js_1.default.getInstance().parsers['clearspeak'] = new Parser();
