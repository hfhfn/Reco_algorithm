...
let _init = false;
function loadLocale(locale = engine_js_1.default.getInstance().locale) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return engine_js_1.EnginePromise.promises[dynamic_cstr_js_1.DynamicCstr.BASE_LOCALE].then(() => __awaiter(this, void 0, void 0, function* () {
            const defLoc = engine_js_1.default.getInstance().defaultLocale;
            if (defLoc) {
                _loadLocale(defLoc);
...
function _loadLocale(locale = engine_js_1.default.getInstance().locale) {
...
function loadMethod() {
    if (engine_js_1.default.getInstance().customLoader) {
        return engine_js_1.default.getInstance().customLoader;
    }
...
function retrieveFiles(locale) {
    ...
    const promise = new Promise((res) => {
        ...
        inner.then((str) => {
            ...
            engine_js_1.default.getInstance().locale = engine_js_1.default.getInstance().defaultLocale;
            res(locale);
        });
    });
...
function retrieveMaps(locale) {
    if (engine_js_1.default.getInstance().isIE &&
        engine_js_1.default.getInstance().mode === EngineConst.Mode.HTTP) {
        getJsonIE_(locale);
        return;
    }
...
function loadFile(locale) {
    ...
    return new Promise((res, rej) => {
        system_external_js_1.default.fs.readFile(file, 'utf8', (err, json) => {
            if (err) {
                return rej(err);
            }
            res(json);
...
function loadFileSync(locale) {
    ...
    return new Promise((res, rej) => {
        let str = '{}';
        try {
            str = system_external_js_1.default.fs.readFileSync(file, 'utf8');
        }
        catch (err) {
            return rej(err);
        }
