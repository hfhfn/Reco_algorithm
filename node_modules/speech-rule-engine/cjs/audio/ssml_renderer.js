...
class SsmlRenderer extends xml_renderer_js_1.XmlRenderer {
    finalize(str) {
        return ('<?xml version="1.0"?><speak version="1.1"' +
            ...
            ` xml:lang="${engine_js_1.default.getInstance().locale}">` +
            '<prosody rate="' +
            engine_js_1.default.getInstance().getRate() +
            '%">' +
            this.separator +
            str +
            this.separator +
    ...
    merge(spans) {
        ...
        for (let i = 0; i < spans.length; i++) {
            ...
            const id = engine_js_1.default.getInstance().automark
                ? span.attributes['id']
                : engine_js_1.default.getInstance().mark
            ...
            if (engine_js_1.default.getInstance().character &&
