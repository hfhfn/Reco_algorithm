...
const SemanticHeuristics = require("./semantic_heuristic_factory.js");
...
class SemanticProcessor {
    ...
    static exprFont_(node) {
        ...
        const singleFont = meaning.reduce(function (prev, curr) {
            if (!prev ||
                !curr.font ||
                curr.font === semantic_meaning_js_1.SemanticFont.UNKNOWN ||
                curr.font === prev) {
                return prev;
            }
            if (prev === semantic_meaning_js_1.SemanticFont.UNKNOWN) {
                return curr.font;
            }
            return null;
    ...
    prefixNode_(node, prefixes) {
        ...
        while (newPrefixes.length > 0) {
            ...
            newNode = SemanticProcessor.getInstance().concatNode_(newNode, op, "prefixop");
