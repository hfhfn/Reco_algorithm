...
(function (NamedSymbol) {
    NamedSymbol.functionApplication = String.fromCodePoint(0x2061);
    NamedSymbol.invisibleTimes = String.fromCodePoint(0x2062);
    NamedSymbol.invisibleComma = String.fromCodePoint(0x2063);
    NamedSymbol.invisiblePlus = String.fromCodePoint(0x2064);
})(NamedSymbol = exports.NamedSymbol || (exports.NamedSymbol = {}));
...
(function (SemanticMap) {
    SemanticMap.Meaning = new meaningMap();
    SemanticMap.Secondary = new secondaryMap();
    SemanticMap.FencesHoriz = new Map();
    SemanticMap.FencesVert = new Map();
})(SemanticMap = exports.SemanticMap || (exports.SemanticMap = {}));
function addMeaning(symbols, meaning) {
    for (const symbol of symbols) {
        SemanticMap.Meaning.set(symbol, {
            role: meaning.role || "unknown",
            type: meaning.type || "unknown",
...
function isMatchingFence(open, close) {
    ...
    if (meaning.type !== "fence") {
        return false;
    }
    if (meaning.role === "neutral" ||
        meaning.role === "metric") {
        return open === close;
    }
    ...
    for (const [name, font] of Object.entries(semantic_meaning_js_1.SemanticFont)) {
        ...
        const semfont = emb
            ...
            : font === semantic_meaning_js_1.SemanticFont.FULLWIDTH
                ...
                : font;
        singleAlphabet(Alphabet.Base.LATINCAP, "identifier", "latinletter", font, semfont, [semantic_meaning_js_1.SemanticSecondary.ALLLETTERS]);
        singleAlphabet(Alphabet.Base.LATINSMALL, "identifier", "latinletter", font, semfont, [semantic_meaning_js_1.SemanticSecondary.ALLLETTERS], {}, { 3: semantic_meaning_js_1.SemanticSecondary.D });
        singleAlphabet(Alphabet.Base.GREEKCAP, "identifier", "greekletter", font, semfont, [semantic_meaning_js_1.SemanticSecondary.ALLLETTERS]);
        singleAlphabet(Alphabet.Base.GREEKSMALL, "identifier", "greekletter", font, semfont, [semantic_meaning_js_1.SemanticSecondary.ALLLETTERS], {
            0: {
                type: "operator",
                role: "prefix operator",
                font: semfont
        ...
        singleAlphabet(Alphabet.Base.DIGIT, "number", "integer", font, semfont);
    }
}
initMeaning();
initFences();
