...
class Cli {
    constructor() {
        this.process = system_external_js_1.default.extRequire('process');
        this.setup = {
            mode: EngineConst.Mode.SYNC
        };
        this.processors = [];
        this.output = this.process.stdout;
        this.dp = new system_external_js_1.default.xmldom.DOMParser({
    ...
    enumerate(all = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (all ? this.loadLocales() : promise).then(() => engine_js_1.EnginePromise.getall().then(() => {
                ...
                const markdown = system_external_js_1.default.commander.opts().pprint;
    ...
    readline() {
        ...
        const inter = system_external_js_1.default.extRequire('readline').createInterface({
    ...
    commandLine() {
        return __awaiter(this, void 0, void 0, function* () {
            const commander = system_external_js_1.default.commander;
            const system = System;
            const set = ((key) => {
            ...
            if (options.output) {
                this.output = system_external_js_1.default.fs.createWriteStream(options.output);
            }
            if (options.verbose) {
    ...
    runProcessors_(processor, input) {
        try {
            ...
            debugger_js_1.Debugger.getInstance().exit(() => this.process.exit(1));
        }
    }
