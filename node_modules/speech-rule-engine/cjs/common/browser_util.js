...
function loadWGXpath(opt_isEdge) {
    loadScript(system_external_js_1.default.WGXpath);
...
function installWGXpath(opt_isEdge, opt_count) {
    ...
    system_external_js_1.default.wgxpath = wgxpath;
    opt_isEdge
        ? system_external_js_1.default.wgxpath.install({ document: document })
        : system_external_js_1.default.wgxpath.install();
...
function loadMapsForIE() {
    loadScript(system_external_js_1.default.mathmapsIePath);
}
function loadScript(src) {
    const scr = system_external_js_1.default.document.createElement('script');
    scr.type = 'text/javascript';
    scr.src = src;
    system_external_js_1.default.document.head
        ? system_external_js_1.default.document.head.appendChild(scr)
        : system_external_js_1.default.document.body.appendChild(scr);
}
