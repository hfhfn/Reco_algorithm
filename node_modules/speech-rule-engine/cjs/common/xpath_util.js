...
exports.xpath = {
    ...
    evaluate: xpathSupported()
        ? document.evaluate
        : system_external_js_1.default.xpath.evaluate,
    result: xpathSupported() ? XPathResult : system_external_js_1.default.xpath.XPathResult,
    createNSResolver: xpathSupported()
        ? document.createNSResolver
        : system_external_js_1.default.xpath.createNSResolver
};
const nameSpaces = {
...
function evaluateXpath(expression, rootNode, type) {
    return engine_js_1.default.getInstance().mode === EngineConst.Mode.HTTP &&
        !engine_js_1.default.getInstance().isIE &&
        !engine_js_1.default.getInstance().isEdge
