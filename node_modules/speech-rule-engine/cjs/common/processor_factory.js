...
function print(name, data) {
    const processor = get(name);
    return engine_js_1.default.getInstance().pprint
...
set(new processor_js_1.Processor('semantic', {
    ...
    postprocessor: function (xml, _expr) {
        const setting = engine_js_1.default.getInstance().speech;
...
set(new processor_js_1.Processor('enriched', {
    ...
    postprocessor: function (enr, _expr) {
        ...
        let generator;
        switch (engine_js_1.default.getInstance().speech) {
...
set(new processor_js_1.Processor('walker', {
    processor: function (expr) {
        ...
        generator.setOptions({
            modality: engine_js_1.default.getInstance().modality,
            locale: engine_js_1.default.getInstance().locale,
            domain: engine_js_1.default.getInstance().domain,
            style: engine_js_1.default.getInstance().style
        });
        ...
        processor_js_1.Processor.LocalState.walker = WalkerFactory.walker(engine_js_1.default.getInstance().walker, node, generator, processor_js_1.Processor.LocalState.highlighter, eml);
...
set(new processor_js_1.Processor('latex', {
    processor: function (ltx) {
        if (engine_js_1.default.getInstance().modality !== 'braille' ||
            engine_js_1.default.getInstance().locale !== 'euro') {
