...
function parseInput(input) {
    const dp = new system_external_js_1.default.xmldom.DOMParser();
    ...
    try {
        ...
        if (engine_js_1.default.getInstance().mode === EngineConst.Mode.HTTP) {
...
function createElement(tag) {
    return system_external_js_1.default.document.createElement(tag);
}
exports.createElement = createElement;
function createElementNS(url, tag) {
    return system_external_js_1.default.document.createElementNS(url, tag);
}
exports.createElementNS = createElementNS;
function createTextNode(content) {
    return system_external_js_1.default.document.createTextNode(content);
}
...
function serializeXml(node) {
    const xmls = new system_external_js_1.default.xmldom.XMLSerializer();
