...
function numberToWords(num) {
    ...
    if (NUMBERS.special['tens-' + engine_js_1.default.getInstance().subiso]) {
        NUMBERS.tens = NUMBERS.special['tens-' + engine_js_1.default.getInstance().subiso];
    }
    let pos = 0;
    let str = '';
    while (num > 0) {
...
const NUMBERS = (0, messages_js_1.NUMBERS)();
