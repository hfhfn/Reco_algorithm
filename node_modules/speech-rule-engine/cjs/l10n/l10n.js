...
function setSubiso(msg) {
    const subiso = engine_js_1.default.getInstance().subiso;
    if (msg.SUBISO.all.indexOf(subiso) === -1) {
        engine_js_1.default.getInstance().subiso = msg.SUBISO.default;
    }
    msg.SUBISO.current = engine_js_1.default.getInstance().subiso;
}
function getLocale() {
    const locale = variables_js_1.Variables.ensureLocale(engine_js_1.default.getInstance().locale, engine_js_1.default.getInstance().defaultLocale);
    engine_js_1.default.getInstance().locale = locale;
